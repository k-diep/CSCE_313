...
private:
	...
	//for thread-safety
	mutex m;
	condition_variable data_availible; //for wait by pop, signal by push
	condition_variable slot_availible; //waited on by the push, signaled by pop
...
public:
	...
	void push(char* data, int len){
		...
		slot_availible.wait (l, [this]{return q.size() < cap;});
